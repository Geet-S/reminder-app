...
bgimage4= PhotoImage(file ="event.png")
...
ViewEventsImg= PhotoImage(file = "Event.png")
...
listbox = Listbox(root, height = 18,  
                  ...
                  font = "Helvetica", 
                  fg = "mint cream")
GoBack= PhotoImage(file='Go back.png')
...
bgimage= ImageTk.PhotoImage(file = "super.jpg")
...
bgimage3= ImageTk.PhotoImage(file = 'Yellow.png')
...
year=2021
bgimage2= PhotoImage(file = 'CS.png')
